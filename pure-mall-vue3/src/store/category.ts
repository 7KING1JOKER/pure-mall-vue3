...
export const productData: Product[] = [
  ...
  { id: 1003, name: '女士修身短袖T恤', price: 109, sales: 1850, image: 'https://images.unsplash.com/photo-1669361817732-bd1e7e938c07?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fFdvbWVuJ3MlMjBTbGltJTIwRml0JTIwU2hvcnQlMjBTbGVldmUlMjBUJTIwc2hpcnQlMjBTaGlydCUyMGJsYWNrJTIwYW5kJTIwd2hpdGV8ZW58MHx8MHx8fDA%3D' },
  ...
  // 配饰类
  { id: 1037, name: '时尚棒球帽', price: 89, sales: 980, image: 'https://images.unsplash.com/photo-1747257490779-5bdae916478f?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fEZhc2hpb24lMjBiYXNlYmFsbCUyMGNhcCUyMGJsYWNrJTIwYW5kJTIwd2hpdGV8ZW58MHx8MHx8fDA%3D' },
  { id: 1038, name: '羊毛针织围巾', price: 159, sales: 1320, image: 'https://images.unsplash.com/photo-1740133741658-6f084cf762ae?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8V29vbCUyMGtuaXR0ZWQlMjBzY2FyZiUyMGJsYWNrJTIwYW5kJTIwd2hpdGV8ZW58MHx8MHx8fDA%3D' },
...
export const useCategoryStore = defineStore('category', () => {
  // 分类数据
  const categories = ref<CategoryNode[]>(categoryData);
  
  // 所有商品数据
  const allProducts = ref<Product[]>(productData);
  
  // 当前选中的分类
  const currentCategory = ref<{ id: string; label: string }>({
    id: '',
    label: '全部商品'
  });
  ...
  // 排序方式变化
  const handleSortChange = (command: SortType) => {
